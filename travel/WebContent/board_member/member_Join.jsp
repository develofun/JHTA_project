...
<br><br>
<form method="post" action="/member.do?cmd=member_insert" id="frm">
	<div class="form-group">
			<label for="inputId" class="input_title">아이디 : </label>
			<input type="text" class="@@@@@@" id="login_id1" name="login_id" onkeyup="idcheck()"  maxlength="12" placeholder="아이디">
	...
	<div class="form-group">
		...
		<input type="text" class="@@@@@@" id="member_nickname" name="member_nickname" onkeyup="nicknamecheck()" placeholder="닉네임">
		<span id="nicknameresult"></span><br>
	</div>
	<div class="form-group">
		<label for="inputName" class="input_title">이름 : </label>
		<input type="text" class="@@@@@@" id="member_name" name="member_name" placeholder="이름">
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<input type="text" class="@@@@@@" id="member_phone" name="member_phone"  maxlength="11" placeholder="숫자만 입력해 주세요">
	</div>
	<div class="form-group">
		<label for="inputName" class="input_title">이메일 : </label>
		<input type="email" class="@@@@@@" id="member_email" name="member_email" onkeyup="emailcheck()" placeholder="이메일">
		<span id="emailresult"></span><br>
	</div>
	<input type="button" value="가입" onclick="checkValue()">
