...
<style type="text/css">
	#main {width:1000px;height:1700px;margin:auto;}
	#main #submenu {width: 1000px;height: 60px;margin-top:0px;}
	#main #banner {width: 1000px;height: 300px;margin:auto;}
	
	#main #content_div {width: 1000px;height: 1000px;margin-top:10px;}
	#main #content_div #content_div1 {width:975px;height:180px;float:left;margin:5px;padding:5px;}
	#main #content_div #content_div1 #div1_1 {width:965px;height:170px;float:left;margin:5px;}
		
	#main #content_div #content_div2 {width:310px;height:720px;float:left;margin:5px;padding:5px;}
	...
	#main #content_div #content_div3 {width:310px;height:720px;float:left;margin:5px;padding:5px;}
	...
	#main #content_div #content_div4 {width:310px;height:720px;float:left;margin:5px;padding:5px;}
	...
	#main #content_div #content_div5 {width:975px;height:175px;float:left;margin:5px;padding:5px;}
	#main #content_div #content_div5 #div5_1 {width:475px;height:165px;float:left;margin:5px;}
	#main #content_div #content_div5 #div5_2 {width:475px;height:165px;float:left;margin:5px;}
	...
	#content_category {width:1000px;height:1280px;}
	
	#main #content_category #category {width:210px;height:950px;float:left;position:relative;left:10px;margin-top:0px;}
	#main #content_category #category img {width:100%;margin-bottom: 50px;margin-top:10px;}
	#main #content_category #category #small_category {margin-left:40px;}
	#main #content_category #category #small_category a{color:black;text-decoration:none;font-size:15px;}
	#main #content_category #category #small_category ul li {list-style:none;margin-left:-20px;}
	#main #content_category #category #small_category ul li a{color:black;text-decoration:none;font-size:12px;}
	
	#category1 {width:745px;height:1270px;float:right;position:relative;right:10px;margin-top:10px;padding:5px;}
	#category1_div1_title_b {width:745px;height:30px;margin-top:5px;margin-bottom:5px;}
	#category1_div1_title_b img {width:200px;height:30px;position:relative;left:5px;}
	#category1_div1_title_n {width:745px;height:30px;margin-top:10px;margin-bottom:5px;}
	#category1_div1_title_n img {width:200px;height:30px;position:relative;left:5px;}
	#category1_div1_title_i {width:714px;height:40px;position:relative;left:15px;margin-top:30px;margin-bottom:5px;}
	#category1_div1_title_i a {text-decoration:none;font-size: 12px;color:black;float:right;margin-right:10px;margin-top:10px;}
	#category1_div1_title_i img {margin-top:10px;}
	
	#category1_div1_1 {width:715px;height:215px;margin:5px;padding:10px;}
	...
	#category1_div1_1 .bestItems a {text-decoration:none;color:black;font-size:14px;}
	...
	#category1_div1_2 {width:715px;height:215px;margin:5px;padding:10px;}
	#category1_div1_2 .newItems {width:142px;height:180px;margin:7px;padding:10px;float:left;}
	#category1_div1_2 .newItems a {text-decoration:none;color:black;font-size:14px;}
	#category1_div1_2 .newItems img {width:130px;height:130px;position:relative;left:5px;}
	.category1_div1_2_1 {width:140px;height:20px;overflow:hidden;float:left;text-align:center;margin-top:5px;}
	.category1_div1_2_2 {width:140px;height:20px;text-align:center;margin-top:28px;}
	#category1_div1_3 {width:745px;height:700px;margin-top:15px;padding:0px;overflow:auto;}
	.categoty1_div1_3_1 {width:142px;height:180px;margin:10px;padding:10px;float:left;position:relative;left:3px;}
	.categoty1_div1_3_1 img {width:130px;height:130px;position:relative;left:5px;}
	.categoty1_div1_3_1 a {text-decoration:none;color:black;font-size:14px;}
	.categoty1_div1_3_1_1 {width:140px;height:20px;overflow:hidden;float:left;text-align:center;margin-top:5px;}
	.categoty1_div1_3_1_2 {width:140px;height:20px;text-align:center;margin-top:28px;}
	#paging{width:350px;height:25px;margin-top:30px;margin-bottom:20px;text-align:center;float:left;position:relative;left:190px;padding:5px;}
...
<div id="main">
	...
	<div id="banner">
		<!------------------- 메인 슬라이드 div ----------------------->
		<div id="jssor_1" style="position:relative;margin:0 auto;top:0px;width:600px;height:300px;overflow:hidden;visibility:hidden;">
	        <!-- Loading Screen -->
	        ...
	        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:600px;height:300px;overflow:hidden;">
	            <div>
	                <img data-u="image" src="/resources/img/fancy_banner.jpg" />
	                <div data-u="thumb"></div>
	            </div>
	            <div>
	                <img data-u="image" src="/resources/img/food_banner.jpg" />
	                <div data-u="thumb"></div>
	            </div>
	            <div>
	                <img data-u="image" src="/resources/img/kidult_banner_1.jpg" />
	                <div data-u="thumb"></div>
	            </div>
	            <a data-u="any" href="http:/.jssor.com" style="display:none">Banner Slider</a>
	            <div>
	                <img data-u="image" src="/resources/img/kidult_banner.jpg" />
	                <div data-u="thumb"></div>
	            </div>
	        </div>
	        <!-- Thumbnail Navigator -->
	...
	<div id="content_category">
		...
		<div  id="category1">
			...
			<div id="category1_div1_title_n">
				<img src="/resources/img/new_item_img.png">
			</div>
			<div id="category1_div1_2">
				<c:forEach var="nList" items="${nList }">
					<div class="newItems">
						<a href="shoplayout?item_code=${nList.code }">
						<img src="/resources/item_img/${nList.mainimg }">
					<div class="category1_div1_2_1">
						${nList.name }
					</div>
					<div class="category1_div1_2_2">
						${ nList.saleprice}원
					</div>
						</a>
					</div>		
			...
			<div id="category1_div1_title_i">
				<a href="/category?method=lowPrice&search=${requestScope.search }&code=${requestScope.categoryCode}">낮은가격순</a>
				<a href="/category?method=new&search=${requestScope.search }&code=${requestScope.categoryCode}"">신상품순</a>
				<a href="/category?method=best&search=${requestScope.search }&code=${requestScope.categoryCode}"">인기상품순</a>
				<img src="/resources/img/bar.png">
			</div>
			<div id="category1_div1_3">
				<c:forEach var="vo" items="${iList }">
						<div class="categoty1_div1_3_1">
							<a href="shoplayout?item_code=${vo.code }">
							<img src="/resources/item_img/${vo.mainimg }"><br>
							<div class="categoty1_div1_3_1_1">
								${vo.name }
							</div>
							<div class="categoty1_div1_3_1_2">
								${vo.saleprice }원
							</div>
							</a>
						</div>
