...
<div class="board_ldk" align="center">	
	...
	<div class="board_ldk_tab">
		<ul>
			<li><a href="/market.do?cmd=market_read" class="clicked">전체</a></li>
			<li><a href="/market.do?cmd=market_search
						&market_search_option=market_sort
						&market_search_text=판매">판매</a></li>
			<li><a href="/market.do?cmd=market_search
						&market_search_option=market_sort
						&market_search_text=구매">구매</a></li>
			<li><a href="/market.do?cmd=market_search
						&market_search_option=market_category
						&market_search_text=가방">가방</a></li>
			<li><a href="market.do?cmd=market_search
						&market_search_option=market_category
						&market_search_text=의류">의류</a></li>
			<li><a href="market.do?cmd=market_search
						&market_search_option=market_category
						&market_search_text=장비">장비</a></li>
			<li><a href="market.do?cmd=market_search
						&market_search_option=market_category
						&market_search_text=액세서리">액세서리</a></li>
			<li><a href="market.do?cmd=market_search
						&market_search_option=market_category
						&market_search_text=숙박권">숙박권</a></li>
			<li><a href="market.do?cmd=market_search
						&market_search_option=market_category
						&market_search_text=이용권">이용권</a></li>
		</ul>
	...
	<div class="board_ldk_paging">
		...
		<c:choose>
			...
			<input type="button" value=" ≪ " onclick="javascripte:location.href='/market.do?cmd=market_read&pageNum=${startPage-1 }&rowCount=${rowCount }'">			
			</c:when>
			<c:otherwise>
		...
		<c:choose>
			...
			<input type="button" value=" 이전 " onclick="javascripte:location.href='/market.do?cmd=market_read&pageNum=${pageNum-1 }&rowCount=${rowCount }'">
			</c:when>
			<c:otherwise>
		...
		<c:forEach var="i" begin="${startPage }" end="${endPage }">
			<c:choose>
				...
				<c:otherwise><a href="/market.do?cmd=market_read&pageNum=${i }&rowCount=${rowCount }">[${i}]</a></c:otherwise>
			</c:choose>
		</c:forEach>
		...
		<c:choose>
			...
			<input type="button" value=" 다음 " onclick="javascripte:location.href='/market.do?cmd=market_read&pageNum=${pageNum+1 }&rowCount=${rowCount }'">
			</c:when>
			<c:otherwise>
		...
		<c:choose>
			...
			<input type="button" value=" ≫ " onclick="javascripte:location.href='/market.do?cmd=market_read&pageNum=${endPage+1 }&rowCount=${rowCount }'">
			</c:when>
			<c:otherwise>			
			<input type="button" value=" ≫ ">
			</c:otherwise>
		...
		<div style="float:right">
			<select id="rowCount_change" onchange="location.href='/market.do?cmd=market_read&pageNum=${pageNum }&rowCount='+this.value">
