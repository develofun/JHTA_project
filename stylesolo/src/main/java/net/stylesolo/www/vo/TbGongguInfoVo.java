...
public class TbGongguInfoVo {
	...
	public TbGongguInfoVo() {}

	public TbGongguInfoVo(int gonggu_insert_num, String gonggu_insert_title, String gonggu_insert_content,
			...
			String gonggu_img_sname, Date gonggu_img_date) {
		super();
