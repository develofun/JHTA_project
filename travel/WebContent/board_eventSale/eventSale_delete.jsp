...
<div class="board_market_content">
	<table border="1" width="800">
		<thead>
			<tr><th>구분</th><th>카테고리</th><th>작성자</th><th>제목</th><th>가격</th><th>조회수</th></tr>
		</thead>
		<tbody>
			<c:forEach var="dto" items="${list }" begin="${startRow }" end="${endRow }">
				<tr>
				...
				<td style="text-align:right"><fmt:formatNumber value="${dto.market_price }" pattern="#,###"/></td>
